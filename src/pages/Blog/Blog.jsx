    ...
    <div className="container mx-auto p-3">
      ...
      <div>
        ...
        <div className="ml-4">
          ...
          <p>
            ...
            PropTypes validators, such as PropTypes.string, PropTypes.number, or
            PropTypes.arrayOf(PropTypes.string).
          </p>
          <p>
            5. React will automatically check the provided props against the
            specified PropTypes and display warnings in the console if there are
            any validation errors.
          </p>
          <p>
            6. Make sure to test your code thoroughly during development, as
            PropTypes are only checked in development mode and not in production
            builds.
          </p>
        </div>
      </div>
      <div>
        ...
        <p className="ml-4">
          ...
          JavaScript engine. It comes with built-in modules and APIs, making it
          suitable for developing server-side applications, REST APIs, real-time
          applications, and command-line tools. Node.js leverages its
          non-blocking, event-driven architecture and supports asynchronous
          programming, which allows for efficient handling of concurrent
          requests and I/O operations.
        </p>
        <p className="mt-3 underline">Express Js</p>
        <p className="ml-4">
          Express.js is a lightweight web application framework that is built on
          top of Node.js. It provides a range of features and utilities to
          simplify web application development, including handling HTTP
          requests, routing, middleware, and view rendering. Express.js follows
          a minimalist approach, allowing developers to create flexible and
          customizable web applications by selecting additional libraries and
          components. With its simplicity, flexibility, and ease of use,
          Express.js has become a popular choice for building web applications
          and APIs using Node.js as the underlying foundation.
        </p>
      </div>
      <div>
        <h2 className="text-lg font-bold mt-3">
        ...
        <p className="mt-3">
          {" "}
          a custom hook in React is a JavaScript function that utilizes built-in
          hooks and allows you to encapsulate reusable logic and stateful
          behavior. Creating a custom hook offers several benefits such as
          reusability, abstraction of complex logic, and managing stateful
          logic. By extracting common logic into a custom hook, you can reuse it
          across multiple components, keep your codebase clean and organized,
          and promote code reuse. Custom hooks provide a way to modularize and
          share functionality, enhancing code readability, maintainability, and
